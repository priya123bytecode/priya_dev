        ...
        $("section.module").each(function () {
          ...
          if ($(this).hasClass("style-12")) {
            if (ST + wHeight / 2 >= moduleTop) {
              ...
              ST < moduleTop - wHeight &&
              $(this).hasClass("counting")
            ) {
              ...
              setTimeout(function () {
                $("section.module.style-12 .graph span").removeClass(
                  "no-delay"
                );
              }, 200);
            }
      ...
      .on("mousewheel.sticky", function (event) {
        ...
        $($(".product").get().reverse()).each(function () {
          if (
            ...
            $(document).scrollTop() <
              $(this).offset().top + $(this).innerHeight()
          ) {
            $product = $(this);
            return false;
          }
